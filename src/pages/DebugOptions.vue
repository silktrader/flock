...
<template>
  ...
  <q-page>
    ...
    <q-list padding>
      ...
      <q-item>
        <q-item-section>
          <q-item-label>Location Prompt</q-item-label>
          <q-item-label caption>Handle Sapienza facilities in a distinct location prompt, or use a combined one.
          </q-item-label>
          <div class="segmented-button-container">
            <q-btn-toggle
              v-model="us.options.debug.combinedLocation"
              :options="[{label: 'Combined Locations', value: true}, {label: 'Separate Locations', value: false}]"
              class="button-toggle"
            />
          </div>
        </q-item-section>
      ...
      <q-item>
        <q-item-section>
          <q-item-label>Lecture Hints</q-item-label>
          <q-item-label caption>Display vertically expanded hints suggesting lecture times, or more primitive, tabular,
            ones.
          </q-item-label>
          <div class="segmented-button-container">
            <q-btn-toggle
              v-model="us.options.debug.lectureHints"
              :options="[{label: 'Vertical Hints', value: LectureHints.Vertical}, {label: 'Tabular Hints', value: LectureHints.Tabular}]"
              class="button-toggle"
            />
          </div>
        </q-item-section>
